...
% Great listing style, source: https://tex.stackexchange.com/questions/116534/lstlisting-line-wrapping
\lstset{
  basicstyle=\ttfamily,
...
\begin{document}
    ...
    \input{section/outils.tex}

    \input{section/osint.tex}

    \input{section/scenario.tex}
